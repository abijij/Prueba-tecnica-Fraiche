...
export const ModalPickImageClient = ({ openGallery, openCamera, setModalUseState, modalUseState }: Props) => {
  return (
    <Modal
      animationType="slide"
      transparent={true}
          ...
          <View style={styles.modalView}>
            ...
            <View style={styles.buttonContainer}>
              <RoundedButton
                ...
                text='Galeria'
                buttonStyle={{
                  backgroundColor: MyColors.admin //Cambio color de alerta dependiendo el rol del usuario
                }}
              />
            </View>
            <View style={styles.buttonContainer}>
