...
export const ModalPickMultipleImageClient = ({ openGallery, openCamera, setModalUseState, modalUseState, numberImage }: Props) => {
  return (
            ...
            <View style={styles.modalView}>
              ...
              <View style={styles.buttonContainer}>
                <RoundedButton
                  ...
                  text='Galeria'
                  buttonStyle={{ backgroundColor: MyColors.client }}
                />
              </View>
              <View style={styles.buttonContainer}>
